...
#' @param force Download the data whether it exists or not (please be kind to the serves).
#' 
#' @return A data frame with weekly variant numbers
#' @export
get_canada_variants <- function(path = "data/canada_variants.csv", force = FALSE){
