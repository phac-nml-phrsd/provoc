...
There is a another potential issue with including or excluding lineages. In the table above we looked at mutations 1 through 4 because they were present in variants A, B, and C. If we introduced variant D which also included mutation 5, then we would be using another mutation in the estimation procedure.
